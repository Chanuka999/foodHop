                      ...
                      <td className={tableClasses.cellBase}>
                        <div className="space-y-1 max-h-52 overflow-auto">
                          {(order.items || []).map((itm, idx) => (
                            ...
                            >
                              <img
                                src={`${API_URL}${itm.item?.imageUrl || ""}`}
                                alt={itm.item?.name || "item"}
                                className="w-10 h-10 object-cover rounded-lg"
                              />
                              <div className="flex-1">
                                <span className="text-amber-100/10 text-sm block truncate">
                                  {itm.item?.name || "Item"}
                                </span>

                                <div className="flex items-center gap-2 text-xs text-amber-400/80">
                                  <span>LKR{itm.item.price}</span>
                                  <span>$dot;</span>
                      ...
                      <td className={tableClasses.cellBase}>
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            className={`px-4 py-2 rounded-lg ${stat.lg} ${stat.color} border border-amber-500/20 text-sm cursor-pointer`}
                          >
