    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative">
        <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
          <div className="space-y-4 sm:space-y-8 px-4 sm:px-0">
            ...
            <p className="text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic border-1-4 bg-amber-500/60 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent">
              ...
              meals,but culinary journeys that linger on the palate and in the
              heart"
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
            ...
            >
              <span className="absolute inset-0 ng-gradient-to-r from-amber-600/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
        ...
        <div className="w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500">
          <div className="relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-500/30 duration-500 shadow-2xl shadow-black/50">
            {/* Gradient background (z-0) and image above it (z-10) so the image is visible */}
            <div className="absolute inset-0 bg-gradient-to-br from-amber-400/15 via-transparent to-amber-600/30 z-0" />
            <img
              src={aboutImage}
              alt="Restaurant"
              className="w-full h-full object-cover aspect-[3/4] transform rotate-1 hover:rotate-0 transition-all duration-500 relative z-10"
            />
