...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] text-amber-500 overflow-hidden relative">
      <div className="about inset-0 opacity-10 mix-blend-soft-light" />
      <motion.section
      ...
      <section className="py-16 px-4 md:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Meet Our <span className="text-amber-500">Culinary Artisans</span>
          </motion.h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12">
            {teamMembers.map((m, i) => (
              <motion.div
                ...
                className="relative group"
              >
                <div className="relative h-full bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border-2 border-amber-600/30 hover:border-amber-500 transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-amber-500/20">
