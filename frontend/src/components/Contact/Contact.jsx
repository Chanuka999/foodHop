...
const Contact = () => {
  ...
  `;
    ...
    const whatsappNumber = "0772849767";

    const whatsappUrl = `https://api.whatsapp.com/send?phone=${whatsappNumber}&text=${encodedMessage}`;

    toast.success("OPENING WHAPSAPP...", {
      style: {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-1-4 border-amber-500 hover:border-amber-600 group">
              ...
              <div className="flex items-center mb-4 relative z-10">
                <div className="p-3 bg-gradient-to-br from-amber-500/50 to-amber-700/30 rounded-xl">
                  <FiMapPin className="text-amber-100 text-2xl animate-pulse" />
                </div>
            ...
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-1-4 border-green-500 hover:border-amber-600 group">
              ...
              <div className="flex items-center mb-4 relative z-10">
                <div className="p-3 bg-gradient-to-br from-green-500/10 to-green-700/10 rounded-xl">
                  <FiPhone className="text-green-100 text-2xl animate-ping" />
                </div>
                <h3 className="ml-4 text-amber-100 text-xl font-semibold">
                  Contact Number
                </h3>
              ...
              <div className="pl-12 space-y-2 z-10">
                <p className="text-amber-100 font-light items-center">
                  <FiGlobe className="text-green-400 text-xl mr-2" /> +94
                  772849767
                </p>
              </div>
            </div>
            ...
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-1-4 border-amber-500 hover:border-amber-600 group">
              ...
              <div className="flex items-center mb-4 relative z-10">
                <div className="p-3 bg-gradient-to-br from-orange-500/50 to-orange-700/30 rounded-xl">
                  <FiMail className="text-orange-100 text-2xl animate-pulse" />
                </div>
          ...
          <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slide-in-right border-2 border-amber-500/30 hover:border-amber-500/50 transform-border duration-300">
            <div className="absolute -top-4 -right-4 w-12 h-12 bg-amber-500/10 rounded-full animate-ping-slow" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div key={name}>
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
                        <Icon className="text-amber-500 text-x animate-pulse" />
                      </div>
                      <input
                        type="type"
                        value={formData[name]}
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/10 rounded-xl text-amber-50 focus:ring-2 focus:right-amber-500 focus:border-transparent placeholder:amber-200/50"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-3 top-4">
                    <FiMessageSquare className="text-amber-500 text-x animate-pulse" />
                  </div>
                  <textarea
                    rows="4"
                    name="query"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r form-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-semibold py-3 ppx6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-amber-500/20 flex items-center justify-center space-x-2 group"
              >
